...
public class AddDevicePage extends GenericWrappers {
	...
	String newAddDdevicePageactualScreenshotPath ="./Actual_screenshots/Newdevicepairingpagescreenshot.png";
	String newAddDdevicePageExpectedScreenshotPath ="./ExpectedScreenshots/Newdevicepairingpage.png";
	...
	@FindBy(xpath = "//*[@resource-id='menu_text_addDevice']")
	private WebElement addAnotherDeviceButton;
...
//	private WebElement exitPairingok_popup;
	...
	private WebElement NewDevicePairing_ButtonText;
	...
	public AddDevicePage clickAddanotherDeviceButton() {
		clickbyXpath(addAnotherDeviceButton,"Add another device");
		return this;
	}
...
public void newDevicePairingscreencheck() throws Exception {
takescreenshotofpages(fullpage, "./ExpectedScreenshots/Newdevicepairingpage.png");
screenShotsCheck(fullpage, newAddDdevicePageactualScreenshotPath,newAddDdevicePageExpectedScreenshotPath , "New add device page");
}
