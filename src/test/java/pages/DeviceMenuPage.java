...
//	@FindBy(xpath = "//android.widget.TextView[@text='']")
	@FindBy(xpath = "//*[@resource-id='menu_text_deviceSettings']")
	...
	@FindBy(xpath = "//*[@resource-id='DeviceSetting_energysaving_Icon']")
	private WebElement energySavingMode;
	@FindBy(xpath = "//*[@resource-id='DeviceSettings_LED_toggle']")
	private WebElement LedquietmodeToggle_AfterPairing;
...
//	@FindBy(xpath = "//android.widget.TextView[@text=\"max007_1\"]")
...
//	private WebElement thresholdValueHighInput;
	...
	@FindBy(xpath = "//android.widget.EditText[@text=\"160\"]")
	private WebElement thresholdValueLowInput;
	@FindBy(xpath = "//android.widget.EditText[@text=\"275\"]")
	private WebElement thresholdValueHighInput;
	...
	public void checkLEDdefaultvalue() {
verifyTextContainsByXpathinAttributes(quietLEDToggleEnable,"false", "Led default state", "checked");
		
	}
	public void infinitePoweronDefaultvalue() {
		verifyTextContainsByXpathinAttributes(infiniteToggle,"true" , "infinite power default state", "checked");
...
clickbyXpath(lowvoltageconfiguration, "LowVoltage configuration");
		...
		public void clickDurationforOnbutton() {
			clickbyXpath(durationForON, "Duration for On");
		}
		public void clickEnergySavingModebutton() {
			clickbyXpath(energySavingMode, "Energy saving mode");
		}
		public void LedQuiteModeToggle() {
			clickbyXpath(LedquietmodeToggle_AfterPairing,"Led Quite mode Toggle");
		}
		...
		public void checkEnergySavingDefautvalue_devicesettings() {
			...
			verifyTextContainsByXpath(energysavingHeader, "Energy Saving Modes", "Energy saving mode header");
			clickbyXpath(EnableToogleSwtich, "Toggle switch");
			clickbyXpath(EnableToogleSwtich, "Toggle switch");
