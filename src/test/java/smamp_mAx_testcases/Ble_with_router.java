...
public class Ble_with_router extends MobileAppWrappers {
	...
	public void startTestCase() {
		testCaseName = "End to End functionality check of Ble with router pairing ";
...
//			sZephyrinfopage.capacityCheck("8");//Enter capacity in ton
